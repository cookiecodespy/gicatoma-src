            ...
            <div className="relative h-full flex items-center justify-center px-6 sm:px-10 lg:px-16 pb-16 sm:pb-24">
              <div className="w-full max-w-7xl">
                <div className="mx-auto max-w-3xl text-center">
                  ...
                  <p className="text-xl md:text-2xl text-white/90 leading-relaxed animate-slide-up-delay mb-6">
                    {slide.subtitle}
                  </p>
              ...
              [
                ...
                <div key={title} className="flex flex-col items-center justify-center gap-1.5">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="font-semibold text-white text-sm md:text-base tracking-wide">{title}</h3>
