...
import { Shield, FileText, BarChart3, Settings, Briefcase, Scan, ArrowRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      features: ['Escaneo masivo y clasificación', 'Organización digital', 'Almacenamiento seguro en la nube'],
    ...
    },
    {
      ...
      description: 'Evaluación exhaustiva de procesos, identificación de riesgos y aseguramiento del cumplimiento normativo.',
      features: ['Auditoría interna y externa', 'Gestión de riesgos', 'Compliance regulatorio', 'Reportes ejecutivos'],
    ...
    },
    {
      ...
      features: ['Planificación fiscal', 'Declaraciones tributarias', 'Reestructuraciones', 'Defensa ante autoridades'],
    ...
    },
    {
      ...
      features: ['Estados financieros', 'Análisis de rentabilidad', 'Proyecciones financieras', 'Valuaciones'],
    ...
    },
    {
      ...
      features: ['Mapeo de procesos', 'Automatización', 'Control de calidad', 'Mejora continua'],
    ...
    },
    {
      ...
      features: ['Planeación estratégica', 'Análisis de mercado', 'Fusiones y adquisiciones', 'Transformación digital'],
